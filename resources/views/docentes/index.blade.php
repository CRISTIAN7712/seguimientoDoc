                ...
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                           <a href="{{route('docente.edit',$docente->idDocente)}}" class="btn btn-warning"><i class="fa fa-marker"></i></a>
                          <form action="{{ route('docentes.destroy', $docente->idDocente) }}" method ="POST" style="display: inline-block;" onsubmit="return confirm('Esta seguro que desea eliminar el registro?')">
                              @csrf @method('DELETE')
